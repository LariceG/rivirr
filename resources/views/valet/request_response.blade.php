...
<div class="row">
	...
	@endif
      <p class="text-form"><b>Driver who accept the call </b></p>
...
<div class="frm">  <span> Model </span><input type="text" readonly class="form-control" name="model" value="{{ $ticket_details->model }}" /></div>
 <a onclick="return confirm('Are you sure want to send it? ');" href="{{ url('/valet/client_car_ready/'.$ticket_details->ticketno) }}"><div class="frm"> <input type="button" name="Tell client car ready " class="btn sbt" value="Tell client car ready" />
 </div></a>
  </div></div>
      <div class="row">
