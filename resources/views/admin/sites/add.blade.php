								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										...
										<div class="row">
                                            ...
                                            <label for="username" class=" form-control-label">Site Name</label>
                                            <input type="text" id="username" required name="site_name" placeholder="Enter Site Name" class="form-control">
                                            <div class="help-block with-errors"></div>
                                                </div>
                                               
                                                <div class="form-group">
                                                    <label for="location" class=" form-control-label">Site Location</label>
                                                    <input type="text" required id="location"  name="site_location" placeholder="Enter Site Location"  class="form-control">
                                                    <div class="help-block with-errors"></div>
                                                </div>
