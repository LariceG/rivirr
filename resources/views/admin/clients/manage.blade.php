						...
						<div class="panel panel-default card-view">
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<div style="width:100%;display:flex;justify-content:flex-end;"><a href="{{ url('/admin/'.$active.'/add') }}"><button class="btn  btn-success ">Add Client</button></a></div>
									@endif
										...
										@foreach($datas as $key => $data)
                                            <tr>
												...
												<a href="{{ url('admin/client/profile/'.$data->id.'?datable_1_length=10#')}}"><button class="btn btn-success">View</button></a>
